...
os.system(f"pyside6-uic {current_dir}/ui/licenses.ui -o {current_dir}/ui/licenses_ui.py")
os.system(f"pyside6-uic {current_dir}/ui/no_internet.ui -o {current_dir}/ui/no_internet.py")
